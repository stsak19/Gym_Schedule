...
self.addEventListener("fetch", (event) => {
  ...
  /* Οι σελίδες και το manifest πάνε πάντα πρώτα στο δίκτυο. Το manifest
     κουβαλάει το χρώμα της μπάρας και το όνομα, οπότε αν σερβιριστεί
     παλιό από τη μνήμη, το κινητό κρατάει τα παλιά. */
  if (req.mode === "navigate" ||
      (sameOrigin && url.pathname.endsWith(".html")) ||
      (sameOrigin && url.pathname.endsWith("manifest.json"))) {
